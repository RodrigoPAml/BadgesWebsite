...
import { GetPagedCompetences } from '../../services/Competences';
import { GetPagedBadges } from '../../services/Badges';
import { Card, Typography, Avatar, Box } from '@mui/material';
import DataGridStore from '../../components/stores/competences/dataGridStore'
      ...
      <>
        <Box sx={{ display: 'flex', height: '70px' }}>
          <Avatar sx={{ width: '60px', height: '60px', ml: '10px', mt: '10px' }}>
            <AssignmentIndIcon sx={{ width: '35px', height: '35px' }} />
          </Avatar>
          <Typography sx={{ ml: '10px', mt: '10px' }} variant="h4">Competências</Typography>
        </Box>
          ...
          rowActions={[
            {
              ...
              onClick: (item) => {
                const dialogId = window.openDialog({
                  title: 'Editando Competência "' + get(item, 'description') + '"',
                  container: FormContainer,
            ...
            },
            {
              ...
              onClick: (item) => {
                const dialogId = window.openDialog({
                  title: 'Deletar Competência "' + get(item, 'description') + '"',
